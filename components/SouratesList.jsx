export default function SouratesList() {
    const sourates = [
      ...
      { name: "Al-Qiyama", number: 74 },
      { name: "Al-Insan", number: 75 },
      { name: "Al-Mursalat", number: 76 },
      { name: "An-Naba", number: 77 },
      { name: "An-Nazi'at", number: 78 },
      { name: "Abasa", number: 79 },
      { name: "At-Takwir", number: 80 },
      { name: "Al-Infitar", number: 81 },
      { name: "Al-Mutaffifin", number: 82 },
      { name: "Al-Inshiqaq", number: 83 },
      { name: "Al-Burooj", number: 84 },
      { name: "At-Tariq", number: 85 },
      { name: "Al-Alaq", number: 96 },
      { name: "Al-Qadr", number: 97 },
      { name: "Al-Bayyina", number: 98 },
      { name: "Az-Zalzalah", number: 99 },
      { name: "Al-Adiyat", number: 100 },
      { name: "Al-Qari'a", number: 101 },
    ...
    return (
      <div className="py-10 bg-gray-900">
        <h2 className="text-3xl font-bold text-center text-green-700">Liste des Sourates</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-6">
          {sourates.map((sourate) => (
            ...
            >
              <h3 className="text-xl font-bold text-green-700">{sourate.number}. {sourate.name}</h3>
            </div>
          ))}
        </div>
      </div>
